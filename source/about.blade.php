...
@section('body')
    ...
    <img src="/assets/img/headshot.png"
        alt="About image"
        class="flex w-64 h-64 mx-auto my-2 bg-contain rounded-full md:float-right md:ml-10">

    <p class="mb-6">My name's Jaco van den Bergh. By day, I do software development for a ticketing company in South Africa. In my free time I like to build and hack on things that makes me excited or my life easier.</p>
